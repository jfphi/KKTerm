# itops.actions.duplicate

- **English value**: `Duplicate`
- **Namespace**: `itops`
...
- **Domain notes**: `Server Room and Rack are durable IT Ops topology entities. Preserve the capitalized product terms where the locale normally does so.`

<!--
Filename: itops.actions.duplicate.md
