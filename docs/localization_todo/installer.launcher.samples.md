# installer.launcher.samples

- **English value**: `Sample commands`
- **Namespace**: `installer`
...
- **Domain notes**: The command lines themselves are untranslated terminal content.

<!--
Filename: installer.launcher.samples.md
