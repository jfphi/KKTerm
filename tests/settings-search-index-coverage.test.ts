...
const NON_SEARCHABLE_KEYS: Record<SettingsSectionId, readonly string[]> = {
  ...
  "credentials-settings": [
    ...
    "settings.savedCredentialHostHint", "settings.savedCredentialLinkApply",
    ...
    "settings.savedCredentialMergeTitle", "settings.savedCredentialMergeTypeHint",
    ...
    "settings.savedCredentialUnlink", "settings.savedCredentialUnused",
